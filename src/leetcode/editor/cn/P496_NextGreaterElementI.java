...
//
//<div><div>Related Topics</div><div><li>栈</li><li>数组</li><li>哈希表</li><li>单调栈</li></div></div><br><div><li>👍 893</li><li>👎 0</li></div>
    ...
    public int[] nextGreaterElement(int[] nums1, int[] nums2) {
		...
		for (int i = 0; i < nums2.length; i++) {
			while (!stack.isEmpty() && nums2[stack.peek()]<nums2[i]) {
				mark[nums2[stack.peek()]] = nums2[i];
				stack.pop();
			}
			stack.push(i);
		}
		while (!stack.isEmpty()) {
			mark[nums2[stack.pop()]] = -1;
		}
